            ...
            <div class="d-flex row justify-content-center align-items-center align-middle" style="margin-top: 10em; margin-bottom: 10em;">
                <div class="col-6 text-center">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <a id="btnEntrada" href="/Entrada" class="btn custom-btn btn-lg btn-block w-100 mb-2" style="height: 52px; background: #42FF00;"><strong>Entrada</strong></a>
                    </div>

                    <div class="d-flex align-items-center mb-2">
                        <img src="Imagens/Inventario.png" alt="Imagem" class="mr-2 mb-2">
                        <a id="btnInventario" href="/Inventario" class="btn custom-btn btn-lg btn-block w-100 mb-2" style="background: #42FF00"><strong>Inventario</strong></a>
                    </div>

                    <div class="d-flex align-items-center mb-2">
                        <img src="Imagens/Saida.png" alt="Imagem" class="mr-2 mb-2">
                        <a id="btnSaida" href="/Saida" class="btn custom-btn btn-lg btn-block w-100 mb-2" style="background: #42FF00"><strong>Saída</strong></a>
                    </div>
                </div>
            </div>
        </div>
