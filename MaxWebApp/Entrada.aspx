...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div class="d-flex">
		...
		<div class="form-group row m-2 col-2">
			...
			<div class="input-group input-group-prepen">
				...
				<input type="number" min="1" step="any" class="form-control" id="valorItem" runat="server"/>
			</div>
		</div>
	</div>
	...
	<button id="botaoCancelar" type="button" class="btn btn-danger m-3">Cancelar</button>
</asp:Content>
