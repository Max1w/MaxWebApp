						...
						<div class="d-flex w-100 pt-3 mt-2 justify-content-center rounded" style="background: rgb(177, 174, 174, 0.1);">
							<div class="d-flex flex-column col-5">
								...
								<div class="" style="">
									...
									<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtDataAquisicao" ErrorMessage="Este campo é obrigatório" CssClass="text-danger"></asp:RequiredFieldValidator>
								</div>
								<div class="" style="">
									...
									<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtVidaUtil" ErrorMessage="Este campo é obrigatório" CssClass="text-danger"></asp:RequiredFieldValidator>
								</div>
								<div class="" style="">
